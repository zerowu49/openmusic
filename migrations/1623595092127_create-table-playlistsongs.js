...
exports.up = (pgm) => {
    ...
    */
    ...
    pgm.addConstraint('playlistsongs', 'fk_collaborations.playlist_id_playlists.id', 'FOREIGN KEY(playlist_id) REFERENCES songs(id) ON DELETE CASCADE');
    pgm.addConstraint('playlistsongs', 'fk_collaborations.song_id_songs.id', 'FOREIGN KEY(song_id) REFERENCES playlists(id) ON DELETE CASCADE');
};
